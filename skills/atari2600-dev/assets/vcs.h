...
;
; Latest Revisions...
; 1.07  08/OCT/2021     Added timer interrupt registers
...
INTIM       ds 1    ; $284      Timer output (and disable timer interrupt)

TIMINT      ds 1    ; $285      Read the interrupt flags

        ; Mirrored registers, part 1 ($285-$294)

            ds 1    ; $286      Mirror of INTIM
            ds 1    ; $287      Mirror of TIMINT
            ds 1    ; $288      Mirror of SWCHA
            ds 1    ; $289      Mirror of SWACNT
            ds 1    ; $28A      Mirror of SWCHB
            ds 1    ; $28B      Mirror of SWBCNT
            ds 1    ; $28C      Timer output (and enable timer interrupt)
            ds 1    ; $28D      Mirror of TIMINT
            ds 1    ; $28E      Mirror of $28C
            ds 1    ; $28F      Mirror of TIMINT
            ds 1    ; $290      Mirror of SWCHA
            ds 1    ; $291      Mirror of SWACNT
            ds 1    ; $292      Mirror of SWCHB
            ds 1    ; $293      Mirror of SWBCNT

TIM1T       ds 1    ; $294      set 1 clock interval (and disable timer interrupt)
TIM8T       ds 1    ; $295      set 8 clock interval (and disable timer interrupt)
TIM64T      ds 1    ; $296      set 64 clock interval (and disable timer interrupt)
T1024T      ds 1    ; $297      set 1024 clock interval (and disable timer interrupt)

      ; Mirrored registers, part 2 ($298-$29b)

            ds 1    ; $298      Mirror of SWCHA
            ds 1    ; $299      Mirror of SWACNT
            ds 1    ; $29A      Mirror of SWCHB
            ds 1    ; $29B      Mirror of SWBCNT

TIM1I       ds 1    ; $29C      set 1 clock interval (and enable timer interrupt)
TIM8I       ds 1    ; $29D      set 8 clock interval (and enable timer interrupt)
TIM64I      ds 1    ; $29E      set 64 clock interval (and enable timer interrupt)
T1024I      ds 1    ; $29F      set 1024 clock interval (and enable timer interrupt)
